...
urlpatterns = [
    ...
    path("committee-detail/<int:committee_pk>/", login_required(CommitteeDetailView.as_view()), name="committee_detail"),
    ...
    path("committee-detail/<int:committee_pk>/add-meeting-type/",
         login_required(AddMeetingTypeView.as_view()), name="add_meeting_type"),
]
